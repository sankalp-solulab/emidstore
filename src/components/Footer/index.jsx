        ...
        <div className="row">
          <div className="col-md-5">
            <div className="bookmarks row">
              ...
              <div className="col-md-4 col-sm-4 col-xs-4 fadeInUp" data-wow-delay="0.2s">
              ...
              <div className="col-md-4 col-sm-4 col-xs-4 wow fadeInUp" data-wow-delay="0.4s">
            ...
            <div className="contact">
              ...
              <div className="row">
                <div className="pl-0 col-md-12">
                  <ul>
                    <li className="mail"><a href="mailto:apps@emedstore.com" title="apps@emedstore.com">apps@emedstore.com</a></li>
                    <li className="skype"><a href="skype:emedstore?call" title="Call EMedStore on Skype">emedstore</a></li>
                  </ul>
                </div>
              </div>
              <div className="row country-row">
                <div className="pl-0 col-md-5">
                  <div className="country pl">
                    Poland
                  </div>
                  <ul>
                    <li className="address">ul. Krowoderskich&nbsp;Zuchów 12<br /><nobr>31-272</nobr>&nbsp;Cracow, Poland</li>
                    <li className="phone"><a href="tel:+48 12 307 15 14" title="+48 12 307 15 14">+48 12 307 15 14</a></li>
                    <li>VAT UE: PL6762505351</li>
                  </ul>
                </div>
                <div className="pl-0 col-md-5">
                  <div className="country gb">
                    United Kingdom
                  </div>
                  <ul>
                    <li className="address">3 High Street<br />BH15&nbsp;1AB&nbsp;Poole, Dorset</li>
                    <li className="phone"><a href="tel:+44 238 097 0485" title="+44 238 097 0485">+44 238 097 0485</a></li>
