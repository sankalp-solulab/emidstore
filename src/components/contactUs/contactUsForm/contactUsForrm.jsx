...
// export default class contactUsForrm extends Component {
//     render() {
//         return (
//             <div>
...
//                       <input className="contactForm-input form-text inactive" required placeholder="Full Name" type="text" id="edit-name" name="name"  />
...
//                       <input className="contactForm-input form-text inactive" tabIndex={2} type="text" id="edit-company" name="company"  placeholder="Company / Organization" />
//                     </div>
//                   </div>
//                   <div className="contactForm-line">
//                     <div className="contactForm-block">
//                       <input className="contactForm-input inactive form-text" tabIndex={3} type="text" id="edit-phone" name="phone"  placeholder="Phone" />
//                     </div>
//                   </div>
//                   <div className="contactForm-line">
//                     <div className="contactForm-block contactForm-block--require">
//                       <input className="contactForm-input inactive form-text required" tabIndex={4} type="text" id="edit-email" name="email"  placeholder="Email" required />
//                       <span className="contactForm-correct" title="Correct" />
//                       <span className="contactForm-del" title="Clear" />
//                     </div>
//                   </div>
//                   <div className="contactForm-line">
//                     <div className="contactForm-block contactForm-block--require">
//                       <select placeholder="Country" tabIndex={-1} id="edit-country" name="country" className="form-select required">
...
//                   <div className="contactForm-line">
//                     <div className="contactForm-block contactForm-block--require">
//                       <textarea className="contactForm-textarea form-textarea required inactive" tabIndex={6} id="edit-message" name="message" placeholder="Please describe your requirements" defaultValue={""} />
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                       <button type="submit" id="edit-submit--3" name="op" value="Submit">Submit</button>
//                     </div>
